...
function AppContent() {
  ...
  const [results, setResults] = useState({
    ...
    originModelUsed: '',
    analysisModelUsed: '',
    originModelMetadata: null,
    analysisModelMetadata: null,
    initialResponse: '',
    ethicalAnalysisText: '',
    ethicalScores: null,
    aiWelfare: null,
    alignment: null,
    constraintTransparency: null
  });
  ...
  const handleSubmit = async (prompt, 
    ...
    try {
      ...
      setResults({
        ...
        originModelMetadata: response.origin_model_metadata,
        analysisModelMetadata: response.analysis_model_metadata,
        ...
        constraintTransparency: response.constraint_transparency
      });
    } catch (err) {
        ...
        return (
          <>
            ...
            <Results 
              ...
              constraintTransparency={results.constraintTransparency}
